...
* Ensure you have [Docker](https://www.docker.com/products/docker-desktop/) and Docker Compose installed and running on your machine.  
...
To stop the running containers, press Ctrl \+ C in your terminal, or run the following command in another terminal window within the project directory:  
docker-compose down  
